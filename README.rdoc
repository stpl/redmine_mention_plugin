{<img src="https://travis-ci.org/stpl/redmine_mention_plugin.svg?branch=master" alt="Build status for branch dev" />}[https://travis-ci.org/stpl/redmine_mention_plugin]
